...
| CLAUDE.md, qa_agent.md | ≤200 | >200 | >300 | Всегда в контексте = расход токенов |
| docs/*.md | ≤400 | >500 | >700 | Microsoft Docs: 200-800 ideal range |
| README.md | ≤150 | >200 | >300 | Entry point, должен быть scannable |
...
2. Имя `CLAUDE.md` или `qa_agent.md` → CLAUDE.md/qa_agent.md
3. Имя `README.md` → README.md
4. Расширение `.yaml` или `.yml` → YAML config
5. Путь содержит `docs/` → docs/*.md
6. Расширение `.md` → Generic .md
