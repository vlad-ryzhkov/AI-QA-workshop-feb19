...
**Primary Source:** `audit/test-scenarios.md` — результат /testcases. Каждая строка таблицы → автотест.
**Secondary Source:** `audit/test-plan.md` — контекст приоритетов P0/P1/P2.
